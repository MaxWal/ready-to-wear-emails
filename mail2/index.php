<table width="600" id="wrapper" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" border="0" style="border-width:0;" >
    ...
    <tr style="font-family:Arial, Helvetica, sans-serif;" >
        <td class="content_wrapper" style="font-family:Arial, Helvetica, sans-serif;margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" >
            <p class="header" style="font-family:Arial, Helvetica, sans-serif;display:block;margin-top:40px;margin-left:19px;font-size:16px;line-height:24px;width:350px;" >Уважаемый покупатель, ваша корзина скучает по вам!</p>
            <p class="info" style="font-family:Arial, Helvetica, sans-serif;font-size:12px;line-height:20px;display:block;margin-top:24px;margin-bottom:0;margin-right:20px;margin-left:20px;color:#666666;" >Мы не могли не обратить внимание, что некоторое время назад вы оставили покупки в корзине на <a href="//READY-TO-WEAR.RU" style="font-family:Arial, Helvetica, sans-serif;color:#000000;text-decoration:none;font-weight:700;" >READY-TO-WEAR.RU</a>.
                Мы заботливо хотим вам напомнить, что данные товары не зарезервированы, и могут быть проданы в любой момент (мы не понаслышке знаем, как это расстраивает!).
                Ваша корзина очень по вам скучает и попросила нас отправить вам это письмо!</p>
            ...
            <table width="600" align="center" background="http://ready-emails.herokuapp.com/images/big.jpg" cellpadding="0" cellspacing="0" border="0" style="border-width:0;margin-top:53px;background-image:url('http://ready-emails.herokuapp.com/images/big.jpg');" >
                <tr style="font-family:Arial, Helvetica, sans-serif;" >
